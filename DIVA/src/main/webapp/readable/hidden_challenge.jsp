...
AbstractChallenge chall = (AbstractChallenge)req.getInformation(Dictionary.CURRENT_CHALLENGE_OBJ);
%>
...
<body>
	<div class="wrapper">
		...
		<h4>You'll need that source code to finish these last tasks</h4>
		<p>
			Flag: <%=flag %>
		</p>
	</div>
