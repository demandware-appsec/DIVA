...
DynamicCompilerChallenge chall = (DynamicCompilerChallenge)req.getInformation(Dictionary.CURRENT_CHALLENGE_OBJ);
Object output = chall.handleChallengeRequest(req);
%>
...
<body>
	...
	<br/>
		...
		<div class="form-group">
			<input type="text" name="<%=DynamicCompilerChallenge.COMPILER_PARAM %>">
		</div>
			<input type="submit" value="Evaluate">
		</form>
		<br/>
		<pre>Output:<br/><%=output %></pre>
	</div>
										</div>
									</div>
