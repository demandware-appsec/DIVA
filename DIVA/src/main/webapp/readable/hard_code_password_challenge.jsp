...
HardCodePasswordChallenge chall = (HardCodePasswordChallenge)req.getInformation(Dictionary.CURRENT_CHALLENGE_OBJ);
								...
								<div class="col">
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<div id="challenge">
		<h3>Try to guess the Password:</h3>
		<br/>
		<form method=POST autocomplete="off">
			<input type="text" name="<%=HardCodePasswordChallenge.PASSWORD_PARAM %>" >
