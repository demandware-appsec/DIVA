...
CookieChallenge chall = (CookieChallenge)req.getInformation(Dictionary.CURRENT_CHALLENGE_OBJ);
boolean hasAccess = chall.handleChallengeRequest(req);
%>
										...
										<div class="panel-body">
											<div id="challenge">
												<form method=POST autocomplete="off">
													<input type="text" name="<%=CookieChallenge.RED_HERRING%>">
