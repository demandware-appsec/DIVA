...
RFIChallenge chall = (RFIChallenge)req.getInformation(Dictionary.CURRENT_CHALLENGE_OBJ);
								...
								<div class="col">
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<div id="challenge">
												<h3>Choose from a selection of Hacker articles</h3>
												<form method=POST autocomplete="off">
												<div class="radio">
													<input type="radio" name="<%=RFIChallenge.FILE_PARAM%>"
														value="<%=RFIChallenge.PHRACK%>">The Hacker
													Manifesto
													</div>
													<div class="radio">
													<input type="radio"
														name="<%=RFIChallenge.FILE_PARAM%>"
														value="<%=RFIChallenge.WHAT_IS%>">What is a
													Hacker?</div>
													<div class="radio">
													<input type="radio"
														name="<%=RFIChallenge.FILE_PARAM%>"
														value="<%=RFIChallenge.HACKER_ATT%>">A Hacker's
													Attitude </div><input type="submit" value="Read">
												</form>
												<br/>
												<pre><%=contents%></pre>
											</div>
